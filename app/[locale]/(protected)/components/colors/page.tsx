      ...
      <CardContent className="space-y-5">
        <div>
          ...
          <div className="flex flex-wrap gap-4">
            <div className="group">
              <div className="color-box relative h-[96px] 2xl:w-[107px] w-[96px] bg-default-900 rounded-md flex flex-col text-primary-foreground p-4 transition-all  duration-200 group-hover:shadow-xs group-hover:-translate-y-1">
              ...
              <div className="flex-1 text-xs my-1 pt-1 text-default-700">
                Dark
              </div>
              <div className="flex-0 text-xs text-default-700 flex items-center">
                #0F172A
              </div>
            </div>
            <div className="group">
              <div className="color-box relative h-[96px] 2xl:w-[107px] w-[96px] bg-primary-foreground border-default-500 border rounded-md flex flex-col text-default-900  p-4 transition-all duration-200 group-hover:shadow-xs group-hover:-translate-y-1">
                <span className="absolute top-3 end-3 hidden group-hover:block duration-200 transition-all">
                  <CopyButton
                    event="copy_color"
                    name="White"
            ...
            {slates?.map((item, i) => (
              <div key={i} className="group ">
                <div
                 ...
                 group-hover:shadow-xs group-hover:-translate-y-1 ${item.bg}`}
                >
                  <span className="absolute top-3 end-3 hidden group-hover:block duration-200 transition-all">
                    <CopyButton
                      event="copy_color"
          ...
          <div className="flex flex-wrap gap-4">
            {primary?.map((item, i) => (
              <div key={i} className="group">
                ...
                duration-200 group-hover:shadow-xs group-hover:-translate-y-1  ${item.bg}`}
                >
                  <span className="absolute top-3 end-3 hidden group-hover:block duration-200 transition-all">
                    <CopyButton
                      event="copy_color"
            ...
            {warning?.map((item, i) => (
              <div key={i} className="group ">
                <div
                 ...
                 flex flex-col  text-warning-foreground p-4 transition-all duration-200 group-hover:shadow-xs group-hover:-translate-y-1 ${item.bg}`}
                >
                  <span className="absolute top-3 end-3 hidden group-hover:block duration-200 transition-all">
                    <CopyButton
                      event="copy_color"
            ...
            {info?.map((item, i) => (
              <div key={i} className="group">
                <div
                 ...
                 p-4 transition-all duration-200 group-hover:shadow-xs  group-hover:-translate-y-1 ${item.bg}`}
                >
                  <span className="absolute top-3 end-3 hidden group-hover:block duration-200 transition-all">
                    <CopyButton
                      event="copy_color"
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-4">
            {success?.map((item, i) => (
              <div key={i} className="group">
                <div
                  className={`color-box h-[96px] relative 2xl:w-[107px] w-[96px] rounded-md flex flex-col text-success-foreground p-4 transition-all duration-200 group-hover:shadow-xs  group-hover:-translate-y-1 ${item.bg}`}
                >
                  <span className="absolute top-3 end-3 hidden group-hover:block duration-200 transition-all">
                    <CopyButton
                      event="copy_color"
