                    ...
                    <TooltipProvider>
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <Button
                                    size="icon"
                                    className="rounded-full hover:ring-0 hover:ring-transparent bg-default-100 hover:bg-default-100 hover:text-default-900 text-default-900 cursor-pointer">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="flex  gap-1 relative">
                            <textarea
                                ...
                                className="bg-background focus:outline-hidden  rounded-xl break-words ps-8  md:ps-3 px-3 flex-1 h-10 pt-2 p-1 pr-8 no-scrollbar "
                                onKeyDown={(e) => {
