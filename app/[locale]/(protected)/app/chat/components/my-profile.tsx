                ...
                <ScrollArea className="h-full">
                    <div className="p-6">
                        <div className="flex justify-end">
                            <Button size="icon" color="secondary" className="w-8 h-8 cursor-pointer" rounded="full" onClick={() => setChatConfig({ ...chatConfig, showProfile: false })}>
                        ...
                        <Button className="mt-7 cursor-pointer">Logout</Button>
                    </div>
                </ScrollArea>
            </div>
        </div>
