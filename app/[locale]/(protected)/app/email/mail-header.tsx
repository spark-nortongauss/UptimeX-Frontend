  ...
  return (
    <div className="flex gap-2">
      <div className="flex-1 flex items-center gap-1">
        <ToggleMailSidebar />
        <Checkbox className="w-4 h-4 text-default-400 dark:bg-default-300 cursor-pointer" />
        <Input
      ...
      <div className="flex-none">
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button size="icon" className="w-8 h-8 rounded-full bg-default-100 cursor-pointer">
