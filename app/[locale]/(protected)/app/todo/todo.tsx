  ...
  return (
    <>
      ...
      <EditTodo
        ...
        setOpen={setOpenEdit}
      />
      <div className="flex items-center gap-4 border-b border-default-200 dark:border-default-300 last:border-none px-6 py-4 transition-all duration-300 hover:-translate-y-1">
        <div>
        ...
        <Button
          className="bg-transparent text-default-400 ring-offset-transparent hover:bg-transparent hover:ring-0 hover:ring-transparent w-fit cursor-pointer"
          size="icon"
        ...
        <Button
          className="bg-transparent text-default-400 ring-offset-transparent  hover:text-destructive border-none focus-visible:ring-transparent hover:bg-transparent hover:ring-0 hover:ring-transparent px-0 w-fit cursor-pointer"
          size="icon"
