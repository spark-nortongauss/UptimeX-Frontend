          ...
          <CardContent className="p-4">
            ...
            <div className="grid xl:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-5">
              {tables.map((item, i) => (
                <Card
                  className={` ${item.bg}
          price-table  rounded-[6px] p-6 text-default-900/10  relative overflow-hidden z-1
          `}
                  key={i}
                >
                  ...
                  <CardContent className="p-0">
                    ...
                    <div className="price-body space-y-8">
                      ...
                      <div>
                        <Button fullWidth variant="outline" className="cursor-pointer">
                          {item.button}
                        </Button>
                      </div>
                    </div>
                ...
                `}
                  ...
                  <div>
                    {item.bg === "bg-default-900" ? (
                      <Button
                        fullWidth
                        className="border-default-200 border-solid border dark:bg-default-50 dark:hover:bg-default-100 dark:border-default-700 dark:text-default-700 dark:outline-0 dark:ring-0 dark:hover:ring-0 dark:hover:ring-offset-0 cursor-pointer"
                      >
                        {item.button}
                      </Button>
                    ) : (
                      <Button
                        fullWidth
                        variant="outline"
                        className="dark:border-default-700 dark:text-default-700 dark:hover:bg-default-100 cursor-pointer "
                      >
                        {item.button}
                      </Button>
                    )}
