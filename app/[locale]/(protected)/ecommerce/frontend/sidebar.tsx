      ...
      <CardContent className="space-y-6  divide-y divide-default-200  ">
          ...
          {categories.map((category, i) => (
            ...
            >
              <div className="flex gap-3 items-center">
                <Checkbox id={`category_key_${i}`} className="cursor-pointer"/>
                <Label
        ...
        <div className="space-y-2 ltr:-ml-6 ltr:pl-6 rtl:-mr-6 rtl:pr-6">
          ...
          {brands.map((brand, i) => (
            ...
            >
              <div className="flex gap-3 items-center">
                <Checkbox className="cursor-pointer" id={`brand_key_${i}`} />
                <Label
                  className="text-default-800 font-normal"
        ...
        <div className="space-y-2 ltr:-ml-6 ltr:pl-6 rtl:-mr-6 rtl:pr-6">
          ...
          {prices.map((price, i) => (
            ...
            >
              <div className="flex gap-3 items-center">
                <Checkbox className="cursor-pointer" id={`price_${i}`} />
                <Label
                  className="text-default-800 font-normal"
                  htmlFor={`price_${i}`}
                >
        ...
        <div className="space-y-2 ltr:-ml-6 ltr:pl-6 rtl:-mr-6 rtl:pr-6">
          ...
          {ratings.map((rating, i) => (
            ...
            >
              <div className="flex gap-3 items-center">
                <Checkbox className="cursor-pointer" id={`rating_${i}`} />
                <Icon
