    ...
    <div className=" grid grid-cols-12  gap-4  rounded-lg">
      <div className="col-span-12 md:col-span-7 space-y-4 lg:col-span-7 ">
        ...
        <Card className="w-full">
          ...
          <CardContent className="space-y-4">
            <div className="flex flex-wrap items-center gap-4 md:gap-6">
              <Label className="text-sm font-normal w-full md:w-auto">
                Gallery Images (600 X 600)
              </Label>
              <div className="flex-1 w-full md:w-auto">
                <Input
                  className="read-only:leading-0 py-1.5 h-full ps-0 w-full"
                  type="file"
                />
              </div>
            </div>
        ...
        <Card className="w-full">
          ...
          <CardContent className="flex flex-wrap gap-4">
            <Label className="w-full md:w-[130px] flex-none">Description</Label>
            <Textarea
              id="pn4"
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex flex-wrap items-center space-x-10 rtl:space-x-reverse">
      ...
      <div className="col-span-12 md:col-span-5 space-y-4 lg:col-span-5">
        ...
        <Card className="w-full">
          ...
          <CardContent className="space-y-4">
            <div className="flex flex-wrap md:flex-nowrap items-center gap-4 md:gap-0">
              <Label className="w-full md:w-[150px] flex-none">Category</Label>
              <Select>
            ...
            <div className="flex flex-wrap md:flex-nowrap items-center gap-4  md:gap-0">
              <Label className="w-full md:w-[150px] flex-none">Discount</Label>
              <Input
                id="discount"
                type="text"
                placeholder="0"
            ...
            <div className="flex flex-wrap md:flex-nowrap items-center gap-4  md:gap-0">
              <Label className="w-full md:w-[150px] flex-none">Type</Label>
              <Select>
                <SelectTrigger className="w-full cursor-pointer">
