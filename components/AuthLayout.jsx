...
const SocialIcon = ({ provider, onClick, disabled = false }) => {
  const icons = {
    google: (
  ...
  return (
    <button
      onClick={onClick}
      disabled={disabled}
      className="w-12 h-12 rounded-full border border-gray-200 bg-white flex items-center justify-center hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
    >
      {icons[provider]}
    </button>
  )
